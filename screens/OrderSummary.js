...
function OrderSummary() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      <View style={{ backgroundColor: 'white', marginTop: StatusBar.currentHeight }}>
        <View style={styles.OrderSummaryHeader}>
          ...
          />
          <View style={{ width: '85%' }}>
            <Text style={{ fontSize: 16, fontWeight: 400 }} numberOfLines={1} ellipsizeMode="tail">
              Order: {order.id}
            </Text>
        ...
        <View style={{ borderBottomWidth: 0.2, borderBottomColor: 'grey', marginVertical: 10 }} />
        ...
        <View style={{ borderBottomWidth: 0.2, borderBottomColor: 'grey', marginVertical: 15 }} />
      </View>
      ...
      <ScrollView style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <View style={styles.ImageContainer}>
          {order.items.map((item, index) => (
            <View key={item.name + index} style={{ flexDirection: 'row' }}>
              ...
              />
              <View style={{ marginLeft: 20, marginTop: 10, flexDirection: 'column', width: '60%' }}>
        ...
        <View style={{ borderBottomColor: '#b6b6b645', borderBottomWidth: 7, marginTop: 15 }} />

        <View style={{ backgroundColor: 'white' }}>
          <View style={{ flexDirection: 'row', margin: 10, gap: 15, marginLeft: 20 }}>
          ...
          <View style={{ marginLeft: 10 }}>
            ...
            >
              <View>
                <Text style={{ fontSize: 20, color: '#000000eb', fontWeight: 'bold' }}>
                  Total Bill
                </Text>
              ...
              <View>
                <Text style={{ fontSize: 20, marginRight: 30, fontWeight: 'bold' }}>
        ...
        <View style={{ borderBottomColor: '#b6b6b645', borderBottomWidth: 7, marginBottom: 10 }} />
        ...
        <View style={{ marginLeft: 20, paddingBottom: 15 }}>
          ...
          />
          {order.deliveredAt!==null && <OrderDetailsComponent
            label="Order Arrived at"
